# TODO - micro-course-creator

Repository: https://github.com/RanaPriyansh/micro-course-creator.git
Canonical local path: /root/git-repos/app-factory/apps/micro-course-creator
...
## Priority tasks
1. Validate the scaffold/generation path end-to-end with one fresh example output.
2. Document how new apps inherit shared templates, configs, and deployment assumptions.
3. Run the local setup path for micro-course-creator and write exact commands back into README if they are missing or stale.
